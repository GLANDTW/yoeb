...
SetNeedSkillLineData(110,"火球,nil|附加閃電傷害輔助,nil",2,nil,nil)
...
--SetNeedAddTianFu("野蛮人升华=AscendancyNecromancer6-召喚物傷害、光環效果|AscendancyNecromancer12-黑暗統御者|AscendancyNecromancer13-召喚物傷害和生命|AscendancyNecromancer7-無意識侵略|AscendancyNecromancer1-召喚物傷害、施放速度|AscendancyNecromancer9-骸骨屏障|")
