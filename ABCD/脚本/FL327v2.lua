...
--23minLv 数字型 满多少级生效
--24maxLv 数字型 满多少级失效
SetGaoJiHuanZhuangData("女巫|野蛮人|","简易之袍","Metadata/Items/Armours/BodyArmours/BodyInt1","无尽之衣","Tabula Rasa",nil,nil,nil,2,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,999999,nil,70,nil,nil)
