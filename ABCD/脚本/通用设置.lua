...
--SetSaveIndex("可堆叠通货|通货","16",nil,nil,nil,nil,nil,true)
--SetSaveIndex("珠宝","20",nil,nil,nil,nil,nil,true)
--SetSaveIndex("蓝图","20|5|6|7|8|9|10|11|12",nil,nil,nil,nil,nil,true)
--SetSaveIndex("主动技能宝石|辅助技能宝石","6",nil,nil,nil,nil,nil,true)
--SetSaveIndex("命运卡","19",nil,nil,nil,nil,nil,true)
--SetSaveIndex("灾变样品|赛季石|神灵之魂","20",nil,nil,nil,nil,nil,true)
--SetSaveIndex("生命药剂|魔力药剂|复合药剂|功能药剂|盾|坚岩药剂","20|21|22",nil,nil,nil,nil,nil,true)
--SetSaveIndex("地图碎片","24",nil,nil,nil,nil,nil,true)
--SetSaveIndex("项链|戒指|爪|匕首|法杖|单手剑|细剑|单手斧|单手锤|符文匕首|短杖|战杖|弓|长杖|双手剑|双手斧|双手锤|箭袋|腰带|手套|鞋子|衣服|头盔|异界地图|药剂|鱼竿","20|21|22",nil,nil,nil,nil,nil,true)
--SetSaveIndex(nil,"20","污秽圣油","Metadata/Items/Currency/MushruneCorrupt",nil,nil,nil,true)
--SetSaveIndex(nil,"20","绯红圣油","Metadata/Items/Currency/Mushrune8",nil,nil,nil,true)
--SetSaveIndex(nil,"20","漆黑圣油","Metadata/Items/Currency/Mushrune9",nil,nil,nil,true)
--SetSaveIndex(nil,"20","乳白圣油","Metadata/Items/Currency/Mushrune10",nil,nil,nil,true)
--SetSaveIndex(nil,"20","白银圣油","Metadata/Items/Currency/Mushrune11",nil,nil,nil,true)
--SetSaveIndex(nil,"20","金色圣油","Metadata/Items/Currency/Mushrune12",nil,nil,nil,true)
--SetSaveIndex(nil,"20","祭祀裂片","Metadata/Items/Currency/CurrencyRitualSplinter")
--SetSaveIndex(nil,"20","圣油萃取器","Metadata/Items/Currency/CurrencyExtractOil",nil,nil,nil,true) --吸油器
--SetSaveIndex(nil,"20|21|22","終極混沌鑄新儀","Metadata/Items/Delve/DelveSocketableCurrencyReroll4",nil,nil,nil,true)
--SetSaveIndex(nil,"16","点金石","Metadata/Items/Currency/CurrencyUpgradeToRare",nil,nil,nil,true)
--SetSaveIndex(nil,"16","重铸石","Metadata/Items/Currency/CurrencyConvertToNormal",nil,nil,nil,true)
--SetSaveIndex(nil,"16","后悔石","Metadata/Items/Currency/CurrencyPassiveRefund",nil,nil,nil,true)
--SetSaveIndex(nil,"16","工匠石","Metadata/Items/Currency/CurrencyRerollSocketNumbers",nil,nil,nil,true)
--SetSaveIndex(nil,"16","富豪石","Metadata/Items/Currency/CurrencyUpgradeMagicToRare",nil,nil,nil,true)
--SetSaveIndex(nil,"16","银币","Metadata/Items/Currency/CurrencySilverCoin",nil,nil,nil,true)
--SetSaveIndex(nil,"16","混沌石","Metadata/Items/Currency/CurrencyRerollRare",nil,nil,nil,true)
--SetSaveIndex(nil,"16","崇高石","Metadata/Items/Currency/CurrencyAddModToRare",nil,nil,nil,true)
--SetSaveIndex(nil,"16","瓦尔宝珠","Metadata/Items/Currency/CurrencyCorrupt",nil,nil,nil,true)
--SetSaveIndex(nil,"16","撤销石","Metadata/Items/Currency/CurrencyAtlasPassiveRefund",nil,nil,nil,true)
--SetSaveIndex(nil,"16","製圖釘","Metadata/Items/Currency/CurrencyCartographersChisel",nil,nil,nil,true)
--SetSaveIndex(nil,"16","宝石匠的棱镜","Metadata/Items/Currency/CurrencyGemQuality",nil,nil,nil,true)
--SetSaveIndex(nil,"16","剥离石","Metadata/Items/Currency/CurrencyRemoveMod",nil,nil,nil,true)
--SetSaveIndex(nil,"16","改造石","Metadata/Items/Currency/CurrencyRerollMagic",nil,nil,nil,true)
--SetSaveIndex(nil,"16","机会石","Metadata/Items/Currency/CurrencyUpgradeRandomly",nil,nil,nil,true)
--SetSaveIndex(nil,"16","幻色石","Metadata/Items/Currency/CurrencyRerollSocketColours",nil,nil,nil,true)
--SetSaveIndex(nil,"16","链结石","Metadata/Items/Currency/CurrencyRerollSocketLinks",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","拓印的封魔之玉","Metadata/Items/Currency/CurrencyItemisedCapturedMonster",nil,nil,nil,true)
--SetSaveIndex(nil,"16","点燃石","Metadata/Items/Currency/CurrencyEnkindlingOrb",nil,nil,nil,true)
--SetSaveIndex(nil,"16","滴注石","Metadata/Items/Currency/CurrencyInstillingOrb",nil,nil,nil,true)
--SetSaveIndex(nil,"16","銀幣","Metadata/Items/Currency/CurrencyAncestralSilverCoin",nil,nil,nil,true)
--SetSaveIndex(nil,"16","低阶异能灰烬","Metadata/Items/Currency/CurrencyEldritchEmber1",nil,nil,nil,true)
--SetSaveIndex(nil,"16","低阶异能灵液","Metadata/Items/Currency/CurrencyEldritchIchor1",nil,nil,nil,true)

--SetSaveIndex(nil,"20","埃哈的記憶","Metadata/Items/MemoryLines/MemoryLineEinhar",nil,nil,nil,true)
--SetSaveIndex(nil,"20","艾瓦的記憶","Metadata/Items/MemoryLines/MemoryLineAlva",nil,nil,nil,true)
--SetSaveIndex(nil,"20","尼科的記憶","Metadata/Items/MemoryLines/MemoryLineNiko",nil,nil,nil,true)
--SetSaveIndex(nil,"20","埃哈的記憶","Metadata/Items/MemoryLines/MemoryLineEinhar",nil,nil,nil,true)
--SetSaveIndex(nil,"20","虛誕遺鑰","Metadata/Items/MapFragments/VoidbornVaultKey",nil,nil,nil,true)
----SetSaveIndex(nil,"8|9|10|11|12|13","禁忌之书","Metadata/Items/Sanctum/SanctumKey",nil,nil,nil,true)

--SetSaveIndex(nil,"20","譫妄玉","Metadata/Items/Currency/CurrencyDeliriumOrb",nil,nil,nil,true)
--SetSaveIndex(nil,"16","製圖六分儀．覺醒","Metadata/Items/Currency/CurrencyAddAtlasModHigh",nil,nil,nil,true)
--SetSaveIndex(nil,"16","多稜的催化劑","Metadata/Items/Currency/CurrencyJewelleryQualityResistance",nil,nil,nil,true)
--SetSaveIndex(nil,"16","富饒的催化劑","Metadata/Items/Currency/CurrencyJewelleryQualityResource",nil,nil,nil,true)
--SetSaveIndex(nil,"16","易变催化剂","Metadata/Items/Currency/CurrencyJewelleryQualityCritical",nil,nil,nil,true)
--SetSaveIndex(nil,"16","冶鍊的催化剂","Metadata/Items/Currency/CurrencyJewelleryQualityDefense",nil,nil,nil,true)
--SetSaveIndex(nil,"16","玷污催化剂","Metadata/Items/Currency/CurrencyJewelleryQualityVaal",nil,nil,nil,true)
--SetSaveIndex(nil,"16","汹涌的催化剂","Metadata/Items/Currency/CurrencyJewelleryQualityElemental",nil,nil,nil,true)
--SetSaveIndex(nil,"16","毒性催化剂","Metadata/Items/Currency/CurrencyJewelleryQualityPhysicalChaos",nil,nil,nil,true)
--SetSaveIndex(nil,"16","加速催化剂","Metadata/Items/Currency/CurrencyJewelleryQualitySpeed",nil,nil,nil,true)

--SetSaveIndex(nil,"20|12|13","魂芯符文之結","Metadata/Items/Currency/RunegraftSouls",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","寶石工藝符文之結","Metadata/Items/Currency/RunegraftSupportLevels",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","巫印符文之結","Metadata/Items/Currency/RunegraftSpellLifeCost",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","改善之預兆","Metadata/Items/Currency/AncestralOmenOnDeathPreventExpLoss",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","白化之預兆","Metadata/Items/Currency/AncestralOmenOnChromaticAddWhiteSockets",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","連結之預兆","Metadata/Items/Currency/AncestralOmenOnFusingMakeFullLinks",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","工匠之預兆","Metadata/Items/Currency/AncestralOmenOnJewellersMakeFullSockets",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","財富之預兆","Metadata/Items/Currency/AncestralOmenOnChanceMakeUnique",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","忠诚符文之結","Metadata/Items/Currency/RunegraftAilmentRedirect",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","堡壘符文之結","Metadata/Items/Currency/RunegraftAttributeGlobalDefences",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","緊密符文之結","Metadata/Items/Currency/RunegraftBootsGloves",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","扭曲符文之結","Metadata/Items/Currency/RunegraftBuffScaling",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","補償符文之結","Metadata/Items/Currency/RunegraftChainMana",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","時間符文之結","Metadata/Items/Currency/RunegraftCooldownRefresh",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","重新縫合符文之結","Metadata/Items/Currency/RunegraftCritRecoup",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","工匠符文之結","Metadata/Items/Currency/RunegraftDamagePerSocket",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","左旋符文之結","Metadata/Items/Currency/RunegraftFlatOffhandAttackTime",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","河川符文之結","Metadata/Items/Currency/RunegraftLowLifeRestore",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","轟鳴符文之結","Metadata/Items/Currency/RunegraftWarcrySpeed",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","穩定符文之結","Metadata/Items/Currency/RunegraftUnexciting",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","瀆神符文之結","Metadata/Items/Currency/RunegraftRandomCurse",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","星印符文之結","Metadata/Items/Currency/RunegraftNovaMarkedTarget",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","戰鬥者符文之結","Metadata/Items/Currency/RunegraftMatchedAttackDamage",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","魂芯符文之結","Metadata/Items/Currency/RunegraftSouls",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","寶石工藝符文之結","Metadata/Items/Currency/RunegraftSupportLevels",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","巫印符文之結","Metadata/Items/Currency/RunegraftSpellLifeCost",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","雷默科偵瞬步的紋身","Metadata/Items/Currency/AncestralTattooRamako4",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","雷默科薩滿的紋身","Metadata/Items/Currency/AncestralTattooRamako5",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","奇塔弗飲血者的紋身","Metadata/Items/Currency/AncestralTattooKitava1",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","努葛瑪呼戰鬥王的紋身","Metadata/Items/Currency/AncestralTattooNgamahu4",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","艾蘿紅薇薩滿的紋身","Metadata/Items/Currency/AncestralTattooArohongui5",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","塔赫亞馬坎加的紋身","Metadata/Items/Currency/AncestralTattooTawhoa7",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","悉妮蔻拉說書人的紋身","Metadata/Items/Currency/AncestralTattooHinekora4",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","雷默科馬坎加的紋身","Metadata/Items/Currency/AncestralTattooRamako7",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","創傷之迴響","Metadata/Items/MapFragments/AtlasMemory/QuestFearKey",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","敬畏之迴響","Metadata/Items/MapFragments/AtlasMemory/QuestBenevolenceKey",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","孤獨之迴響","Metadata/Items/MapFragments/AtlasMemory/QuestIgnoranceKey",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","不滅之火虛靈餘燼","Metadata/Items/MapFragments/CleansedAllflamePack",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","不滅之火骷髏馬克餘燼","Metadata/Items/MapFragments/BetrayalAllflamePack",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","不滅之火傳播餘燼","Metadata/Items/MapFragments/PropagationAllflamePack",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","不滅之火血肉餘燼","Metadata/Items/MapFragments/MeatSackAllflamePack",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","不滅之火荒林餘燼","Metadata/Items/MapFragments/WildwoodAllflamePack",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","不滅之火虛靈餘燼","Metadata/Items/MapFragments/CleansedAllflamePack",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","不滅之火鍍金餘燼","Metadata/Items/MapFragments/GoldAllflamePack",nil,nil,nil,true)
--SetSaveIndex(nil,"20|12|13","不滅之火蟾蜍餘燼","Metadata/Items/MapFragments/ToadAllflamePack",nil,nil,nil,true)
--SetSaveIndex(nil,"20","映像迷霧","Metadata/Items/Currency/ReflectiveMist",nil,nil,nil,true)
--SetSaveIndex(nil,"20","釋界之採購鑿","Metadata/Items/Currency/CurrencyMapQualityRarity",nil,nil,nil,true)
--SetSaveIndex(nil,"20","釋界之增值鑿","Metadata/Items/Currency/CurrencyMapQualityPackSize",nil,nil,nil,true)
--SetSaveIndex(nil,"20","釋界之占卜鑿","Metadata/Items/Currency/CurrencyMapQualityDivinationCards",nil,nil,nil,true)
--SetSaveIndex(nil,"20","釋界之聖甲蟲鑿","Metadata/Items/Currency/CurrencyMapQualityScarabs",nil,nil,nil,true)
--SetSaveIndex(nil,"20","釋界之貪婪鑿","Metadata/Items/Currency/CurrencyMapQualityCurrency",nil,nil,nil,true)
--SetSaveIndex(nil,"20","巨靈瓦爾寶珠","Metadata/Items/Currency/CurrencyMoreCorrupt",nil,nil,nil,true)
--SetSaveIndex(nil,"16","隱匿混沌石","Metadata/Items/Currency/CurrencyRerollRareVeiledChaos",nil,nil,nil,true)
--SetSaveIndex(nil,"16","塑界者的崇高石","Metadata/Items/Currency/CurrencyAddModToRareShaper",nil,nil,nil,true)
--SetSaveIndex(nil,"16","尊師的崇高石","Metadata/Items/Currency/CurrencyAddModToRareElder",nil,nil,nil,true)
--SetSaveIndex(nil,"16","回想石","Metadata/Items/Currency/CurrencyAddZanaInfluence",nil,nil,nil,true)
--SetSaveIndex(nil,"16","拆解石","Metadata/Items/Currency/CurrencyRemoveZanaInfluence",nil,nil,nil,true)
--SetSaveIndex(nil,"16","意志石","Metadata/Items/Currency/CurrencyMoreZanaInfluencedItems",nil,nil,nil,true)
--SetSaveIndex(nil,"16","神圣石","Metadata/Items/Currency/CurrencyModValues",nil,nil,nil,true)
--SetSaveIndex(nil,"16","古變石","Metadata/Items/Currency/CurrencyRerollUnique",nil,nil,nil,true)
--SetSaveIndex(nil,"16","製圖六分儀．3","Metadata/Items/Currency/CurrencyAddAtlasModMid",nil,nil,nil,true)
--SetSaveIndex(nil,"16","先驱石","Metadata/Items/Currency/CurrencyUpgradeMapTier",nil,nil,nil,true)
--SetSaveIndex(nil,"16","崇高石碎片","Metadata/Items/Currency/CurrencyExaltedShard",nil,nil,nil,true)
--SetSaveIndex(nil,"16","初级制图六分仪","Metadata/Items/Currency/CurrencyAddAtlasMod",nil,nil,nil,true)
--SetSaveIndex(nil,"16","豐裕牌組","Metadata/Items/DivinationCards/DivinationCardDeck",nil,nil,nil,true)
--SetSaveIndex(nil,"16","淬鍊石","Metadata/Items/Currency/CurrencyHeistWeaponEnchant",nil,nil,nil,true)
--SetSaveIndex(nil,"16","裁缝石","Metadata/Items/Currency/CurrencyHeistArmourEnchant",nil,nil,nil,true)
--SetSaveIndex(nil,"16","异能混沌石","Metadata/Items/Currency/CurrencyEldritchRerollRare",nil,nil,nil,true)
--SetSaveIndex(nil,"16","异能无效石","Metadata/Items/Currency/CurrencyEldritchRemoveMod",nil,nil,nil,true)

--SetSaveIndex(nil,"16","祝福石","Metadata/Items/Currency/CurrencyRerollImplicit",nil,nil,nil,true)
--SetSaveIndex(nil,"16","地平石","Metadata/Items/Currency/CurrencyRerollMapType",nil,nil,nil,true)

--SetSaveIndex(nil,"20","探險家偵查報告","Metadata/Items/Currency/ScoutingReports/AtlasScoutingReportExplorers",nil,nil,nil,true)
--SetSaveIndex(nil,"20","卓越偵查報告","Metadata/Items/Currency/ScoutingReports/AtlasScoutingReportUnique",nil,nil,nil,true)
--SetSaveIndex(nil,"20","全面偵查報告","Metadata/Items/Currency/ScoutingReports/AtlasScoutingReportMoreHidden",nil,nil,nil,true)
--SetSaveIndex(nil,"20","凋落偵查報告","Metadata/Items/Currency/ScoutingReports/AtlasScoutingReportBlighted",nil,nil,nil,true)
--SetSaveIndex(nil,"20","勢力偵查報告","Metadata/Items/Currency/ScoutingReports/AtlasScoutingReportGuardian",nil,nil,nil,true)
--SetSaveIndex(nil,"20","技工偵查報告","Metadata/Items/Currency/ScoutingReports/AtlasScoutingReportJuiced",nil,nil,nil,true)
--SetSaveIndex(nil,"20","瓦爾偵查報告","Metadata/Items/Currency/ScoutingReports/AtlasScoutingReportCorrupted",nil,nil,nil,true)
--SetSaveIndex(nil,"20","譫妄偵查報告","Metadata/Items/Currency/ScoutingReports/AtlasScoutingReportDelirium",nil,nil,nil,true)
--SetSaveIndex(nil,"20","超凡偵查報告","Metadata/Items/Currency/ScoutingReports/AtlasScoutingReportBreachstone",nil,nil,nil,true)
--SetSaveIndex(nil,"20","調查員的羅盤","Metadata/Items/Currency/CurrencyItemiseSextantModifier",nil,nil,nil,true)
--SetSaveIndex(nil,"20",nil,"Metadata/Items/MemoryLines/MemoryLineEinhar",nil,nil,nil,true)--埃哈的記憶
--SetSaveIndex(nil,"20",nil,"Metadata/Items/MemoryLines/MemoryLineAlva",nil,nil,nil,true)--艾瓦的記憶
--SetSaveIndex(nil,"20",nil,"Metadata/Items/MemoryLines/MemoryLineNiko",nil,nil,nil,true)--尼科的記憶
--SetSaveIndex(nil,"20",nil,"Metadata/Items/MemoryLines/MemoryLineEinhar",nil,nil,nil,true)--埃哈的記憶
--SetSaveIndex(nil,"20",nil,"Metadata/Items/Currency/CrucibleGeode",nil,nil,nil,true)--火炎精晶
--SetSaveIndex(nil,"20",nil,"Metadata/Items/Currency/CrucibleGeodeUber",nil,nil,nil,true)--水晶精晶
--SetSaveIndex(nil,"20",nil,"Metadata/Items/Currency/CurrencyAddCrucibleExperience",nil,nil,nil,true)--岩礦
...
--SetSaveIndex(nil,"20","白银圣油","Metadata/Items/Currency/Mushrune4",nil,nil,nil,true)
--SetSaveIndex(nil,"20","金色圣油","Metadata/Items/Currency/Mushrune18",nil,nil,nil,true)

--SetSaveIndex(nil,"20","盜之印","Metadata/Items/Heist/HeistCoin",nil,nil,nil,true)
--SetSaveIndex(nil,"20","幻像斷片","Metadata/Items/Currency/CurrencySimulacrumSplinter",nil,nil,nil,true)

--SetSaveIndex(nil,"24","裂隙碎片(夏乌拉)","Metadata/Items/Currency/CurrencyBreachChaosShard",nil,nil,nil,true)
--SetSaveIndex(nil,"24","永恒卡鲁裂片","Metadata/Items/Currency/CurrencyLegionKaruiShard",nil,nil,nil,true)
--SetSaveIndex(nil,"24","永恒马拉克斯裂片","Metadata/Items/Currency/CurrencyLegionMarakethShard",nil,nil,nil,true)
--SetSaveIndex(nil,"24","永恒帝国裂片","Metadata/Items/Currency/CurrencyLegionEternalEmpireShard",nil,nil,nil,true)
--SetSaveIndex(nil,"24","永恒圣堂裂片","Metadata/Items/Currency/CurrencyLegionTemplarShard",nil,nil,nil,true)
--SetSaveIndex(nil,"24","永恒瓦尔裂片","Metadata/Items/Currency/CurrencyLegionVaalShard",nil,nil,nil,true)
--SetSaveIndex(nil,"24","裂隙碎片(乌尔尼多)","Metadata/Items/Currency/CurrencyBreachPhysicalShard",nil,nil,nil,true)
--SetSaveIndex(nil,"24","裂隙碎片(托沃)","Metadata/Items/Currency/CurrencyBreachColdShard",nil,nil,nil,true)
--SetSaveIndex(nil,"24","夏烏拉裂痕石","Metadata/Items/Currency/CurrencyChayulasstone",nil,nil,nil,true)
--SetSaveIndex(nil,"24","烏爾尼多裂痕石","Metadata/Items/Currency/CurrencyUulNetolsstone",nil,nil,nil,true)
--SetSaveIndex(nil,"24","托沃裂痕石","Metadata/Items/Currency/CurrencyTulsstone",nil,nil,nil,true)
--SetSaveIndex(nil,"24","索伏裂痕石","Metadata/Items/MapFragments/CurrencyBreachFragmentFire",nil,nil,nil,true)
--SetSaveIndex(nil,"24","艾許裂痕石","Metadata/Items/MapFragments/CurrencyBreachFragmentLightning",nil,nil,nil,true)
--SetSaveIndex(nil,"24","裂隙碎片(索伏)","Metadata/Items/Currency/CurrencyBreachFireShard",nil,nil,nil,true)
--SetSaveIndex(nil,"24","裂隙碎片(艾许)","Metadata/Items/Currency/CurrencyBreachLightningShard",nil,nil,nil,true)
...
--SetSaveIndex(nil,"20|21|22","骸骨之戒","Metadata/Items/Rings/Ring16",nil,nil,nil,true)--骸骨戒指

--SetSaveIndex(nil,"20|2|3",nil,"Metadata/Items/Currency/HarvestSeedRed",nil,nil,nil,true)--野性結晶生靈之力
--SetSaveIndex(nil,"20|2|3",nil,"Metadata/Items/Currency/HarvestSeedGreen",nil,nil,nil,true)--靈現結晶生靈之力
--SetSaveIndex(nil,"20|2|3",nil,"Metadata/Items/Currency/HarvestSeedBlue",nil,nil,nil,true)--原始結晶生靈之力
--SetSaveIndex(nil,"20|2|3",nil,"Metadata/Items/Currency/HarvestSeedBoss",nil,nil,nil,true)--神聖結晶生靈之力

--SetSaveIndex(nil,"20","變態之譫妄玉","Metadata/Items/Currency/CurrencyAmorphousDeliriumOrb",nil,nil,nil,true)
--SetSaveIndex(nil,"20","凋落之譫妄玉","Metadata/Items/Currency/CurrencyBlightedDeliriumOrb",nil,nil,nil,true)
--SetSaveIndex(nil,"20","永恆之譫妄玉","Metadata/Items/Currency/CurrencyTimelessDeliriumOrb",nil,nil,nil,true)
--SetSaveIndex(nil,"20","帝王之譫妄玉","Metadata/Items/Currency/CurrencyImperialDeliriumOrb",nil,nil,nil,true)
--SetSaveIndex(nil,"20","初始之譫妄玉","Metadata/Items/Currency/CurrencyPrimalDeliriumOrb",nil,nil,nil,true)
--SetSaveIndex(nil,"20","聖人之譫妄玉","Metadata/Items/Currency/CurrencyDivinersDeliriumOrb",nil,nil,nil,true)
--SetSaveIndex(nil,"20","預兆之譫妄玉","Metadata/Items/Currency/CurrencyPortentousDeliriumOrb",nil,nil,nil,true)
--SetSaveIndex(nil,"20","石化之譫妄玉","Metadata/Items/Currency/CurrencyFossilisedDeliriumOrb",nil,nil,nil,true)
--SetSaveIndex(nil,"20","飛掠之譫妄玉","Metadata/Items/Currency/CurrencySkitteringDeliriumOrb",nil,nil,nil,true)
--SetSaveIndex(nil,"20","碎片之譫妄玉","Metadata/Items/Currency/CurrencyFragmentedDeliriumOrb",nil,nil,nil,true)
--SetSaveIndex(nil,"20","低語之譫妄玉","Metadata/Items/Currency/CurrencyWhisperingDeliriumOrb",nil,nil,nil,true)
--SetSaveIndex(nil,"20","晦澀之譫妄玉","Metadata/Items/Currency/CurrencyObscuredDeliriumOrb",nil,nil,nil,true)
--SetSaveIndex(nil,"20","預感之譫妄玉","Metadata/Items/Currency/CurrencyForebodingDeliriumOrb",nil,nil,nil,true)
--SetSaveIndex(nil,"20","墮落之譫妄玉","Metadata/Items/Currency/CurrencyDecadentDeliriumOrb",nil,nil,nil,true)
--SetSaveIndex(nil,"20","深淵之譫妄玉","Metadata/Items/Currency/CurrencyAbyssalDeliriumOrb",nil,nil,nil,true)
--SetSaveIndex(nil,"20","飾品之譫妄玉","Metadata/Items/Currency/CurrencyJewellersDeliriumOrb",nil,nil,nil,true)
--SetSaveIndex(nil,"20","製圖之譫妄玉","Metadata/Items/Currency/CurrencyCartographersDeliriumOrb",nil,nil,nil,true)
--SetSaveIndex(nil,"20","護甲之譫妄玉","Metadata/Items/Currency/CurrencyArmoursmithsDeliriumOrb",nil,nil,nil,true)
--SetSaveIndex(nil,"20","鐵匠之譫妄玉","Metadata/Items/Currency/CurrencyBlacksmithsDeliriumOrb",nil,nil,nil,true)
--SetSaveIndex(nil,"20","奇術之譫妄玉","Metadata/Items/Currency/CurrencyThaumaturgesDeliriumOrb",nil,nil,nil,true)
--SetSaveIndex(nil,"20","卓越之譫妄玉","Metadata/Items/Currency/CurrencySingularDeliriumOrb",nil,nil,nil,true)
--SetSaveIndex(nil,"20","精良之譫妄玉","Metadata/Items/Currency/CurrencyFineDeliriumOrb",nil,nil,nil,true)

--SetSaveIndex(nil,"20","药材","Metadata/Items/Currency/CurrencyRefreshGambler",nil,nil,nil,true)
--SetSaveIndex(nil,"20","异域币铸","Metadata/Items/Currency/CurrencyRefreshBarter",nil,nil,nil,true)
--SetSaveIndex(nil,"20","废金属","Metadata/Items/Currency/CurrencyRefreshDealer",nil,nil,nil,true)
--SetSaveIndex(nil,"20","埋葬奖章","Metadata/Items/Currency/CurrencyRefreshSaga",nil,nil,nil,true)
--SetSaveIndex(nil,"20","探险日志","Metadata/Items/Expedition/ExpeditionLogbook",nil,nil,nil,true)
----SetSaveIndex(nil,"碎片","众神神器","Metadata/Items/MapFragments/CurrencyFragmentPantheonFlask",nil,nil,nil,true)
--SetSaveIndex("DelveSocketableCurrency","20",nil,nil,nil,nil,nil,true)--掘獄插槽通貨

--SetSaveIndex(nil,"20",nil,"Metadata/Items/Currency/CurrencyDelveCraftingDefences",nil,nil,nil,true)
--SetSaveIndex(nil,"20",nil,"Metadata/Items/Currency/CurrencyDelveCraftingMinionsAuras",nil,nil,nil,true)
--SetSaveIndex(nil,"20",nil,"Metadata/Items/Currency/CurrencyDelveCraftingBleedPoison",nil,nil,nil,true)
--SetSaveIndex(nil,"20",nil,"Metadata/Items/Currency/CurrencyDelveCraftingQuality",nil,nil,nil,true)
--SetSaveIndex(nil,"20",nil,"Metadata/Items/Currency/CurrencyDelveCraftingEnchant",nil,nil,nil,true)
--SetSaveIndex(nil,"20",nil,"Metadata/Items/Currency/CurrencyDelveCraftingSockets",nil,nil,nil,true)
--SetSaveIndex(nil,"20","紊亂化石","Metadata/Items/Currency/CurrencyDelveCraftingRandom",nil,nil,nil,true)--纠缠化石
--SetSaveIndex(nil,"20","神聖化石","Metadata/Items/Currency/CurrencyDelveCraftingLuckyModRolls",nil,nil,nil,true)--圣洁化石
--SetSaveIndex(nil,"20","鑲金化石","Metadata/Items/Currency/CurrencyDelveCraftingSellPrice",nil,nil,nil,true)--镶金化石
--SetSaveIndex(nil,"20","破裂化石","Metadata/Items/Currency/CurrencyDelveCraftingMirror",nil,nil,nil,true)--分裂化石
--SetSaveIndex(nil,"20","鏤空化石","Metadata/Items/Currency/CurrencyDelveCraftingAbyss",nil,nil,nil,true)--镂空化石
--SetSaveIndex(nil,"20","血漬化石","Metadata/Items/Currency/CurrencyDelveCraftingVaal",nil,nil,nil,true)--溅血化石
--SetSaveIndex(nil,"20","幻像異界","Metadata/Items/MapFragments/CurrencyAfflictionFragment",nil,nil,nil,true)--梦魇拟像

--SetSaveIndex(nil,"23","憎恨之哀嚎精华","Metadata/Items/Currency/CurrencyEssenceHatred4",nil,nil,nil,true)
--SetSaveIndex(nil,"23","憎恨之咆哮精华","Metadata/Items/Currency/CurrencyEssenceHatred5",nil,nil,nil,true)
--SetSaveIndex(nil,"23","憎恨之尖啸精华","Metadata/Items/Currency/CurrencyEssenceHatred6",nil,nil,nil,true)
--SetSaveIndex(nil,"23","憎恨之破空精华","Metadata/Items/Currency/CurrencyEssenceHatred7",nil,nil,nil,true)
--SetSaveIndex(nil,"23","悲痛之哀嚎精华","Metadata/Items/Currency/CurrencyEssenceWoe4",nil,nil,nil,true)
--SetSaveIndex(nil,"23","悲痛之咆哮精华","Metadata/Items/Currency/CurrencyEssenceWoe5",nil,nil,nil,true)
--SetSaveIndex(nil,"23","悲痛之尖啸精华","Metadata/Items/Currency/CurrencyEssenceWoe6",nil,nil,nil,true)
--SetSaveIndex(nil,"23","悲痛之破空精华","Metadata/Items/Currency/CurrencyEssenceWoe7",nil,nil,nil,true)
--SetSaveIndex(nil,"23","贪婪之哀嚎精华","Metadata/Items/Currency/CurrencyEssenceGreed4",nil,nil,nil,true)
--SetSaveIndex(nil,"23","贪婪之咆哮精华","Metadata/Items/Currency/CurrencyEssenceGreed5",nil,nil,nil,true)
--SetSaveIndex(nil,"23","贪婪之尖啸精华","Metadata/Items/Currency/CurrencyEssenceGreed6",nil,nil,nil,true)
--SetSaveIndex(nil,"23","贪婪之破空精华","Metadata/Items/Currency/CurrencyEssenceGreed7",nil,nil,nil,true)
--SetSaveIndex(nil,"23","轻视之哀嚎精华","Metadata/Items/Currency/CurrencyEssenceContempt4",nil,nil,nil,true)
--SetSaveIndex(nil,"23","轻视之咆哮精华","Metadata/Items/Currency/CurrencyEssenceContempt5",nil,nil,nil,true)
--SetSaveIndex(nil,"23","轻视之尖啸精华","Metadata/Items/Currency/CurrencyEssenceContempt6",nil,nil,nil,true)
--SetSaveIndex(nil,"23","轻视之破空精华","Metadata/Items/Currency/CurrencyEssenceContempt7",nil,nil,nil,true)
--SetSaveIndex(nil,"23","哀惜之哀嚎精华","Metadata/Items/Currency/CurrencyEssenceSorrow3",nil,nil,nil,true)
--SetSaveIndex(nil,"23","哀惜之咆哮精华","Metadata/Items/Currency/CurrencyEssenceSorrow4",nil,nil,nil,true)
--SetSaveIndex(nil,"23","哀惜之尖啸精华","Metadata/Items/Currency/CurrencyEssenceSorrow5",nil,nil,nil,true)
--SetSaveIndex(nil,"23","哀惜之破空精华","Metadata/Items/Currency/CurrencyEssenceSorrow6",nil,nil,nil,true)
--SetSaveIndex(nil,"23","愤怒之哀嚎精华","Metadata/Items/Currency/CurrencyEssenceAnger3",nil,nil,nil,true)
--SetSaveIndex(nil,"23","愤怒之咆哮精华","Metadata/Items/Currency/CurrencyEssenceAnger4",nil,nil,nil,true)
--SetSaveIndex(nil,"23","愤怒之尖啸精华","Metadata/Items/Currency/CurrencyEssenceAnger5",nil,nil,nil,true)
--SetSaveIndex(nil,"23","愤怒之破空精华","Metadata/Items/Currency/CurrencyEssenceAnger6",nil,nil,nil,true)
--SetSaveIndex(nil,"23","折磨之哀嚎精华","Metadata/Items/Currency/CurrencyEssenceTorment3",nil,nil,nil,true)
--SetSaveIndex(nil,"23","折磨之咆哮精华","Metadata/Items/Currency/CurrencyEssenceTorment4",nil,nil,nil,true)
--SetSaveIndex(nil,"23","折磨之尖啸精华","Metadata/Items/Currency/CurrencyEssenceTorment5",nil,nil,nil,true)
--SetSaveIndex(nil,"23","折磨之破空精华","Metadata/Items/Currency/CurrencyEssenceTorment6",nil,nil,nil,true)
--SetSaveIndex(nil,"23","恐惧之哀嚎精华","Metadata/Items/Currency/CurrencyEssenceFear3",nil,nil,nil,true)
--SetSaveIndex(nil,"23","恐惧之咆哮精华","Metadata/Items/Currency/CurrencyEssenceFear4",nil,nil,nil,true)
--SetSaveIndex(nil,"23","恐惧之尖啸精华","Metadata/Items/Currency/CurrencyEssenceFear5",nil,nil,nil,true)
--SetSaveIndex(nil,"23","恐惧之破空精华","Metadata/Items/Currency/CurrencyEssenceFear6",nil,nil,nil,true)
--SetSaveIndex(nil,"23","苦难之哀嚎精华","Metadata/Items/Currency/CurrencyEssenceSuffering2",nil,nil,nil,true)
--SetSaveIndex(nil,"23","苦难之咆哮精华","Metadata/Items/Currency/CurrencyEssenceSuffering3",nil,nil,nil,true)
--SetSaveIndex(nil,"23","苦难之尖啸精华","Metadata/Items/Currency/CurrencyEssenceSuffering4",nil,nil,nil,true)
--SetSaveIndex(nil,"23","苦难之破空精华","Metadata/Items/Currency/CurrencyEssenceSuffering5",nil,nil,nil,true)
--SetSaveIndex(nil,"23","肆虐之哀嚎精华","Metadata/Items/Currency/CurrencyEssenceRage2",nil,nil,nil,true)
--SetSaveIndex(nil,"23","肆虐之咆哮精华","Metadata/Items/Currency/CurrencyEssenceRage3",nil,nil,nil,true)
--SetSaveIndex(nil,"23","肆虐之尖啸精华","Metadata/Items/Currency/CurrencyEssenceRage4",nil,nil,nil,true)
--SetSaveIndex(nil,"23","肆虐之破空精华","Metadata/Items/Currency/CurrencyEssenceRage5",nil,nil,nil,true)
--SetSaveIndex(nil,"23","雷霆之哀嚎精华","Metadata/Items/Currency/CurrencyEssenceWrath2",nil,nil,nil,true)
--SetSaveIndex(nil,"23","雷霆之咆哮精华","Metadata/Items/Currency/CurrencyEssenceWrath3",nil,nil,nil,true)
--SetSaveIndex(nil,"23","雷霆之尖啸精华","Metadata/Items/Currency/CurrencyEssenceWrath4",nil,nil,nil,true)
--SetSaveIndex(nil,"23","雷霆之破空精华","Metadata/Items/Currency/CurrencyEssenceWrath5",nil,nil,nil,true)
--SetSaveIndex(nil,"23","疑惑之哀嚎精华","Metadata/Items/Currency/CurrencyEssenceDoubt2",nil,nil,nil,true)
--SetSaveIndex(nil,"23","疑惑之咆哮精华","Metadata/Items/Currency/CurrencyEssenceDoubt3",nil,nil,nil,true)
--SetSaveIndex(nil,"23","疑惑之尖啸精华","Metadata/Items/Currency/CurrencyEssenceDoubt4",nil,nil,nil,true)
--SetSaveIndex(nil,"23","疑惑之破空精华","Metadata/Items/Currency/CurrencyEssenceDoubt5",nil,nil,nil,true)
--SetSaveIndex(nil,"23","煎熬之哀嚎精华","Metadata/Items/Currency/CurrencyEssenceAnguish1",nil,nil,nil,true)
--SetSaveIndex(nil,"23","煎熬之咆哮精华","Metadata/Items/Currency/CurrencyEssenceAnguish2",nil,nil,nil,true)
--SetSaveIndex(nil,"23","煎熬之尖啸精华","Metadata/Items/Currency/CurrencyEssenceAnguish3",nil,nil,nil,true)
--SetSaveIndex(nil,"23","煎熬之破空精华","Metadata/Items/Currency/CurrencyEssenceAnguish4",nil,nil,nil,true)
--SetSaveIndex(nil,"23","厌恶之哀嚎精华","Metadata/Items/Currency/CurrencyEssenceLoathing1",nil,nil,nil,true)
--SetSaveIndex(nil,"23","厌恶之咆哮精华","Metadata/Items/Currency/CurrencyEssenceLoathing2",nil,nil,nil,true)
--SetSaveIndex(nil,"23","厌恶之尖啸精华","Metadata/Items/Currency/CurrencyEssenceLoathing3",nil,nil,nil,true)
--SetSaveIndex(nil,"23","厌恶之破空精华","Metadata/Items/Currency/CurrencyEssenceLoathing4",nil,nil,nil,true)
--SetSaveIndex(nil,"23","刻毒之巨吼精华","Metadata/Items/Currency/CurrencyEssenceSpite1",nil,nil,nil,true)
--SetSaveIndex(nil,"23","刻毒之巨吼精华","Metadata/Items/Currency/CurrencyEssenceSpite2",nil,nil,nil,true)
--SetSaveIndex(nil,"23","刻毒之尖啸精华","Metadata/Items/Currency/CurrencyEssenceSpite3",nil,nil,nil,true)
--SetSaveIndex(nil,"23","刻毒之破空精华","Metadata/Items/Currency/CurrencyEssenceSpite4",nil,nil,nil,true)
--SetSaveIndex(nil,"23","热情之哀嚎精华","Metadata/Items/Currency/CurrencyEssenceZeal1",nil,nil,nil,true)
--SetSaveIndex(nil,"23","热情之巨吼精华","Metadata/Items/Currency/CurrencyEssenceZeal2",nil,nil,nil,true)
--SetSaveIndex(nil,"23","热情之尖啸精华","Metadata/Items/Currency/CurrencyEssenceZeal3",nil,nil,nil,true)
--SetSaveIndex(nil,"23","热情之破空精华","Metadata/Items/Currency/CurrencyEssenceZeal4",nil,nil,nil,true)
--SetSaveIndex(nil,"23","凄惨之咆哮精华","Metadata/Items/Currency/CurrencyEssenceMisery1",nil,nil,nil,true)
--SetSaveIndex(nil,"23","凄惨之尖啸精华","Metadata/Items/Currency/CurrencyEssenceMisery2",nil,nil,nil,true)
--SetSaveIndex(nil,"23","凄惨之破空精华","Metadata/Items/Currency/CurrencyEssenceMisery3",nil,nil,nil,true)
--SetSaveIndex(nil,"23","忌惮之咆哮精华","Metadata/Items/Currency/CurrencyEssenceDread1",nil,nil,nil,true)
--SetSaveIndex(nil,"23","忌惮之尖啸精华","Metadata/Items/Currency/CurrencyEssenceDread2",nil,nil,nil,true)
--SetSaveIndex(nil,"23","忌惮之破空精华","Metadata/Items/Currency/CurrencyEssenceDread3",nil,nil,nil,true)
--SetSaveIndex(nil,"23","傲视之咆哮精华","Metadata/Items/Currency/CurrencyEssenceScorn1",nil,nil,nil,true)
--SetSaveIndex(nil,"23","傲视之尖啸精华","Metadata/Items/Currency/CurrencyEssenceScorn2",nil,nil,nil,true)
--SetSaveIndex(nil,"23","傲视之破空精华","Metadata/Items/Currency/CurrencyEssenceScorn3",nil,nil,nil,true)
--SetSaveIndex(nil,"23","极恐精华","Metadata/Items/Currency/CurrencyEssenceHorror1",nil,nil,nil,true)
--SetSaveIndex(nil,"23","忌妒之咆哮精华","Metadata/Items/Currency/CurrencyEssenceEnvy1",nil,nil,nil,true)
--SetSaveIndex(nil,"23","忌妒之尖啸精华","Metadata/Items/Currency/CurrencyEssenceEnvy2",nil,nil,nil,true)
--SetSaveIndex(nil,"23","忌妒之破空精华","Metadata/Items/Currency/CurrencyEssenceEnvy3",nil,nil,nil,true)
--SetSaveIndex(nil,"23","浮誇精髓","Metadata/Items/Currency/CurrencyEssenceHysteria1",nil,nil,nil,true)--浮夸精华
--SetSaveIndex(nil,"23","錯亂精髓","Metadata/Items/Currency/CurrencyEssenceInsanity1",nil,nil,nil,true)--错乱精华
--SetSaveIndex(nil,"23","極恐精髓","Metadata/Items/Currency/CurrencyEssenceHorror1",nil,nil,nil,true)--极恐精华
--SetSaveIndex(nil,"23","譫妄精髓","Metadata/Items/Currency/CurrencyEssenceDelirium1",nil,nil,nil,true)--谵妄精华
--SetSaveIndex(nil,"23","遗忘的污染器皿","Metadata/Items/Currency/CurrencyCorruptMonolith",nil,nil,nil)

--SetSaveIndex(nil,"20|21|22",nil,nil,nil,"Lioneye's Remorse",nil,true)--"狮眼的荣耀塔盾"
--SetSaveIndex(nil,"20|21|22",nil,nil,nil,"Skullhead",nil,true)--"光辉之颅"
--SetSaveIndex(nil,"20|21|22",nil,nil,nil,"Tabula Rasa",nil,true)--"无尽之衣"
--SetSaveIndex(nil,"20|21|22",nil,nil,nil,"Siegebreaker",nil,true)--"突围"
--SetSaveIndex(nil,"20|21|22",nil,nil,nil,"Aukuna's Will",nil,true)--"奧庫納之意"
--SetSaveIndex(nil,"20|21|22",nil,nil,nil,"Bones of Ullr",nil,true)--"烏勒爾之骨"
--SetSaveIndex(nil,"20|21|22",nil,nil,nil,"Carnage Heart",nil,true)--"屠戮之心"
--SetSaveIndex(nil,"20|21|22",nil,nil,nil,"Alberon's Warpath",nil,true)--"阿尔贝隆的征途"
--SetSaveIndex(nil,"20|21|22",nil,nil,nil,"Chernobog's Pillar",nil,true)--"五芒屏障"
--SetSaveIndex(nil,"20|21|22",nil,nil,nil,"The Jinxed Juju",nil,true)--"恶咒护符"
--SetSaveIndex(nil,"20|21|22",nil,nil,nil,"Daresso's Courage",nil,true)--"德瑞索的勇者之盾"
