...
SetNeedSkillLineData(99,"寒霜爆,nil|冰霜之捷,nil|憎恨,nil",nil,3,nil)
SetNeedSkillLineData(100,"冰霜之刃,nil|多重打擊輔助,nil|夜刃輔助,nil|元素攻擊傷害輔助,nil|三體輔助,nil|啟發輔助,Metadata/Items/Gems/SupportGemReducedMana",nil,nil,nil)
g_shengJiBaoShi=true			--自动升级宝石 true为升级 
...
AddAttackSkillData("寒霜爆","Frost Bomb",nil,nil,10)
AddAttackSkillData("普通攻击","melee")




AddMoveSkillData("迴旋之刃","Whirling Blades")
...
SetSkillLimitMaxLv("啟發輔助",nil,20)
